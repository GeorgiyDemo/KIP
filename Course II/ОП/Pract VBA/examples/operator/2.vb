'Написать программу на VBA, которая позволяет в каждой строке квадратной матрицы
'находить максимальный по модулю элемент и менять его местами с элементом
