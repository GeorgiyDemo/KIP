...
'поиск чисел и их индексы, которые меньше по модулю числа, введенного с клавиатуры
...
Private Sub CommandButton1_Click()
    ...
    Label2.Caption = "Числа, меньше " + CStr(KOT) + " по модулю:" + Chr(13)
    n = CInt(InputBox("Введите размерность массива:"))

    'Вывод исходного массива на Label1, вывод чисел меньше по модулю на Label2
    For i = 1 To n
        a(i) = CInt(Rnd() * 20 - 10)
