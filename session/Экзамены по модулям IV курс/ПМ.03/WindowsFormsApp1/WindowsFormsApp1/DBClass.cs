...
namespace SMSTimetable
{
    ...
    public class DBClass
    {
        ...
        {
            string name;
            MySqlConnection conn = new MySqlConnection(TokenClass.MySQLConnectionString);
            conn.Open();
            try
            {
        ...
        {
            using (var conn = new MySqlConnection(TokenClass.MySQLConnectionString))
            {
        ...
        public static void SQLiteExecute(string sql)
        {
            ...
            SqliteConnection myConn = new SqliteConnection("DataSource="+ TokenClass.SQLitepatch + ";");
        ...
        {
            string outstr = "";
            using (SqliteConnection con = new SqliteConnection("DataSource=" + TokenClass.SQLitepatch + ";"))
            {
                con.Open();
